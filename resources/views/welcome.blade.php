                ...
                <div class="card">
                    <div class="card-body">
                        <div class="form">
                            ...
                            <div class="alert alert-danger" id="role-alert">Your Account has been activated</div>
                            <h3>Login</h3>
                            <hr />
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if(data.success === true){
                    console.log("the activation is ", data.data.activate)
                    if(data.data.activate === 1){
                        if( data.data.role === "2"){
                            window.location.href = host + "staff/dashboard";
                        }
                    }else{
